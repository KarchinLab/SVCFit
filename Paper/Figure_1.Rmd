...
base_dir = '~/Karchin Lab Dropbox/YunZhou Liu/SVCFit-2024/NPJ_Precision_Oncology_submission/mendeley_data/VISOR_benchmark'
...
```{r}
### load the truth
base_dir = '~/Karchin Lab Dropbox/YunZhou Liu/SVCFit-2024/NPJ_Precision_Oncology_submission/mendeley_data/Prostate_mixture'
...
n_sv2cluster <- read.csv("~/Documents/Karchin_lab/combat/annotsv/sv2cluster.csv")
