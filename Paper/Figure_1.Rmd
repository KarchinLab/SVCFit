...
analyze <- function(samp, exper, p_het, p_onsv, p_sv, p_cnv, p_truth, svclone_dir, thresh=0.1, chr=NULL, flank_del=50, QUAL_tresh=100, min_alt=2, t_only=FALSE) {
  ...
  svc <- analyze_svclone(samp, exper, final_truth, sv_info, svclone_dir=svclone_dir)
...
svclone_dir = file.path(base_dir, 'svclone')  # adjust if svclone output lives elsewhere
