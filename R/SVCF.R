...
#' @param truth_path an onject of class "Character". This variable is a path to bed files storing true structural variants information with clonal assignment. Each bed file should be named like "c1.bed, c2.bed" etc. Structural variants should be saved in a seperate bed file if they belong to different (sub)clone.
...
#' @import dplyr
#' @examples example
SVCF <- function(vcf_path, overlap=TRUE, tolerance=6, window=100, multiple=FALSE, tumor_only=FALSE, truth_path=NULL, mode="heritage", length_threshold=0){
