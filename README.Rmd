...
This step build the tumor evolutionary tree based on SV clustering results.
...
Parent nodes should always have higher rank in name than its children (i.e. c3.bed instead of c1.bed) and all child node bed file should conatins its ancesters mutations.
